import { GroceryDto } from '../model/grocery-dto';

export class GroceryMockData {
  static groceries: GroceryDto[] = [
    {
      name: 'Apple',
      description:
    ...
    },
    {
      ...
      additionalInformation:
        'A serving of 1/5 of a medium Haas avocado has 50 calories and 4.5g of fat. The good news is that most of the fat is monounsaturated and polyunsaturated fat, which are both healthy fats.\nAvocados provide a source of fibre and folate.',
    },
    {
      name: 'Blackberries',
      description:
        'Blackberries are available in July and August, though you will see imported varieties in supermarkets most of the year.',
      additionalInformation:
        'Blackberries provide an excellent source of fibre and a good source of Vitamin C.',
    },
    {
      name: 'Cherimoya',
      description:
    ...
    },
    {
      name: 'Cranberries',
      description:
        'Cranberries are very versatile. They can be used in sauces, muffins, salads and desserts',
      additionalInformation:
        'Nutritional value per 100g\nEnergy: 218 kJ (52 kcal)\nCarbohydrates: 13.81g\nSugars: 10.39g\nDietary fiber: 2.4 g\nFat: 0.17 g\nProtein: 0.26 g',
    },
    {
      name: 'Elderberries',
      description:
        'Best are firm berries with a deep colour. Avoid decaying, mushy or bruised fruits.',
      additionalInformation:
    ...
    },
    {
      name: 'Feijoa',
      description:
        'Ripe feijoas normally last about 3 to 5 days. Feijoas peeled and cooked into a puree and frozen.',
      additionalInformation:
        '1 serving = 100 g (2 fruits)\n\nHigh in Vitamin C (34% Recommended Daily Intake per serving)\nSodium-free (3 mg per serving)',
    },
    {
      name: 'Grapefruit',
      description:
  ...
  static getGroceries(): GroceryDto[] {
    return this.groceries;
  }

  static getGroceryByName(name: string): GroceryDto | undefined {
    return this.groceries.find((item) => item.name === name);
  }
}
